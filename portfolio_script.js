...
window.addEventListener('load', ()=>{
    setTimeout(cacherLoader, 2000);            
})

function cacherLoader(){
    const zoneLoader = document.querySelector("#zoneLoader");
    const zoneMenu = document.querySelector("#zoneMenu");
    const zonePersonalisation = document.querySelector("#zonePersonalisation");
    const zonePresentation = document.querySelector("#zonePresentation");
    const zoneFooter = document.querySelector("footer");
    zoneLoader.classList.add('loaderDesactive');
    zoneMenu.style.display = "flex";
    zonePersonalisation.style.display = "flex";
    zonePresentation.style.display = "flex";
    zoneFooter.style.display = "flex";
}
